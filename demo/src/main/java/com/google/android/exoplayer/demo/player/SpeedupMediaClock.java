 ...
 */
/* package */ final class SpeedupMediaClock implements MediaClock {
  ...
  private volatile float mSpeedFactor;
  ...
  private long elapsedRealtimeMinus(long toSubtractUs) {
    return elapsedRealtime() * 1000 - toSubtractUs;
  }

  private long elapsedRealtime() {
    return (long)(((float)SystemClock.elapsedRealtime()) * mSpeedFactor);
  }
